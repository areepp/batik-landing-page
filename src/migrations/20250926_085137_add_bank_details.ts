...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "houses" ADD COLUMN "bank_details_bank_name" varchar DEFAULT 'BRI' NOT NULL;
  ALTER TABLE "houses" ADD COLUMN "bank_details_account_number" varchar DEFAULT '00000000' NOT NULL;
  ALTER TABLE "houses" ADD COLUMN "bank_details_account_holder_name" varchar DEFAULT 'kosong' NOT NULL;`)
}
